...
public class UnstainedStainedMapping extends JPanel {//implements ActionListener {
    ...
    public UnstainedStainedMapping() {
...
//        add(toggleDnD, BorderLayout.PAGE_END);
    ...
    private JPanel createNorthPanel() {
        ...
        JLabel label = new JLabel ("Choose mapping file: ");
        JButton button = new JButton ("Choose file");
        button.addActionListener (new ActionListener() {
            public void actionPerformed (ActionEvent e){
                mappingFile = showOpenDialog ("Choose the Unstained/Stained Compensation File",
                        new JFileChooser(), JFileChooser.FILES_AND_DIRECTORIES);
...
//    }
    ...
    private static void createAndShowGUI() {
        ...
        frame = new JFrame("UnStained-Stained Compensation FCSFiles");
        frame.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);

        //Create and set up the content pane.
        JComponent newContentPane = new UnstainedStainedMapping();
